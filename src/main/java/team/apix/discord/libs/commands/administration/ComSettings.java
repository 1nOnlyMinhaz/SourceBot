package team.apix.discord.libs.commands.administration;
            ...
            if (strings[0].equalsIgnoreCase("tools")) {
                ...
                if (strings[1].equalsIgnoreCase("set")) {
                    if (strings[2].equalsIgnoreCase("role") && message.getMentionedRoles().size() == 1) {
                        ...
                        else if (strings[4].equalsIgnoreCase("server-changelog"))
                            setChannelType(botAPI, sm, em, messageChannel, message, Settings.CHAN_SCHANGELOG);
                    }
